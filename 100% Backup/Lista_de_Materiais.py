...
def criar_janela():
    ...
    def enviar_respostas():
        ...
        messagebox.showinfo("Total de Saidas", f"Total de Saídas: {total_saidas_selecionados}")
    ...
    # Campos de texto
    tk.Label(janela, text="Nome do Cliente:").grid(row=0, column=0, padx=5, pady=5, sticky="e")
    entry_nome = tk.Entry(janela)
    entry_nome.grid(row=0, column=1, padx=5, pady=5)

    tk.Label(janela, text="Equipamento:").grid(row=1, column=0, padx=5, pady=5, sticky="e")
    entry_equipamento = tk.Entry(janela)
    entry_equipamento.grid(row=1, column=1, padx=5, pady=5)

    tk.Label(janela, text="Tipo de Sistema:").grid(row=2, column=0, padx=5, pady=5, sticky="e")
    entry_sistema = tk.Entry(janela)
    entry_sistema.grid(row=2, column=1, padx=5, pady=5)

    tk.Label(janela, text="Tempo ON:").grid(row=3, column=0, padx=5, pady=5, sticky="e")
    entry_tempo_on = tk.Entry(janela)
    entry_tempo_on.grid(row=3, column=1, padx=5, pady=5)

    tk.Label(janela, text="Tempo OFF:").grid(row=4, column=0, padx=5, pady=5, sticky="e")
    entry_tempo_off = tk.Entry(janela)
    entry_tempo_off.grid(row=4, column=1, padx=5, pady=5)

    tk.Label(janela, text="Quantidade de saídas usadas:").grid(row=5, column=0, padx=5, pady=5, sticky="e")
    entry_quantidade_usada = tk.Entry(janela)
    entry_quantidade_usada.grid(row=5, column=1, padx=5, pady=5)

    # Pergunta sobre a bomba
    tk.Label(janela, text="Qual a Bomba:").grid(row=6, column=0, padx=5, pady=5, sticky="e")
    var_bomba = tk.IntVar()
    bombas = [
    ...
    for i, bomba in enumerate(bombas, start=1):
        tk.Radiobutton(janela, text=bomba, variable=var_bomba, value=i).grid(row=5+i, column=1, sticky="w")

    # Pergunta sobre os distribuidores
    tk.Label(janela, text="Selecione os Distribuidores:").grid(row=12, column=0, padx=5, pady=5, sticky="e")
    ...
    for i, (num, distribuidor) in enumerate(distribuidores_nomes.items(), start=1):
        tk.Label(janela, text=distribuidor).grid(row=12+i, column=1, padx=5, pady=5, sticky="w")
    ...
    # Botão Enviar
    tk.Button(janela, text="Enviar", command=enviar_respostas).grid(row=27, column=1, pady=10)
